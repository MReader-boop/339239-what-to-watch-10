...
function FilmScreen({films}: FilmScreenProps): JSX.Element {
  ...
  const film = films.find((x) => x.id === filmId);
            ...
            <div className="film-card__wrap">
              <div className="film-card__desc">
                ...
                <p className="film-card__meta">
                  <span className="film-card__genre">{film.description.genre}</span>
                  <span className="film-card__year">{film.description.year}</span>
                </p>
                ...
                <div className="film-card__buttons">
                  ...
                  <Link to={AppRoutes.AddReview} state={film} className="btn film-card__button">Add review</Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="film-card__wrap film-card__translate-top">
            <div className="film-card__info">
              <div className="film-card__poster film-card__poster--big">
                <img src={film.description.poster} alt={`${film.name} poster`} width="218" height="327" />
              </div>
